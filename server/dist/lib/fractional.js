...
exports.generateKeyBefore = generateKeyBefore;
exports.generateKeyAfter = generateKeyAfter;
exports.generateNKeys = generateNKeys;
...
function charToIndex(c) {
    ...
    if (idx === -1)
        throw new Error(`Invalid character in orderKey: ${c}`);
    return idx;
}
/**
